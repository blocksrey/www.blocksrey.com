...
function isint(num) { return num - floor(num) === 0 }
function approxparse(num) { return isint(num) ? num : '~' + floor(num + 0.5) }
...
function renderstats() {
	if (iters) {
		...
		itersobj.innerHTML = nameobj.value === '' ? 'Please type a name.' : name0 ? 'This villager does not exist.' : ''
